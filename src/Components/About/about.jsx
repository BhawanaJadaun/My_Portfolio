  ...
  return (
    ...
    <div className='about' id='about'>
      ...
      <div className='about-right'>
        <p className='intro'>
          Hello there! My name is <span>Bhawana Jadaun</span>. I am a <span>web designer & developer,</span> and I'm very passionate and dedicated to my work.
          Innovative <span>MERN Stack Developer</span> with a passion for creating dynamic and responsive web applications. Adept in both frontend and backend development, with hands-on experience in <span>HTML5, CSS3, JavaScript, React.js, Node.js, and MongoDB, Rest API.</span> Skilled in building and optimizing web applications, and continuously seeking to expand knowledge in emerging web technologies.
        </p>
      </div>
    </div>
    <div className='Skill'>
    ...
    <h2>~ SKILLS</h2>
    <h1>Tech <span>Stacks</span> I  use</h1>
    </div>
    ...
    <img src = {html}/>
      ...
      <img src = {Tailwand}/>
        <div className='text-box'>
          <h2>TAILWINDCSS</h2>
          <p>Tailwind CSS is an open-source CSS framework. The main feature of this library is that, unlike other CSS frameworks like Bootstrap, it does not provide a series of predefined classes for elements such as buttons or table</p>
          <span className='right-container-arrow'></span>
        </div>
      </div>
      <div className='skill-container left-container'>
      <img src = {node}/>
        <div className='text-box'>
          <h2>Node</h2>
          <p>Node.js is a cross-platform, open-source JavaScript runtime environment that can run on Windows, Linux, Unix, macOS, and more. Node.js runs on the V8 JavaScript engine, and executes JavaScript code outside a web browse</p>
          <span className='left-container-arrow'></span>
        </div>
      </div>
      <div className='skill-container right-container'>
      <img src = {mongodb}/>
        <div className='text-box'>
          <h2>MongoDB</h2>
          <p>MongoDB is a source-available, cross-platform, document-oriented database program. Classified as a NoSQL database product, MongoDB utilizes JSON-like documents with optional schemas. MongoDB is developed by MongoDB Inc. and current versions are licensed under the Server Side</p>
          <span className='right-container-arrow'></span>
        </div>
      </div>
    </div>
...
//         <h2>Bhawana Jadaun</h2>
//         <div className='about-btn'>
//         <button>Got a Project</button>
//         </div>
//       </div>
//       <div className='about-right'>
//       <p>Hello there! My name is <span>Bhawana Jadaun</span>. I am a <span>web designer & developer,</span> and I'm very passionate and dedicated to my work.
